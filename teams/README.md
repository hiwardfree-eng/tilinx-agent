...
- Built on **TilinX Engine** (same prerequisite as Always On: network-reachable API)
- Extends Engine w/ auth + RBAC + per-tenant data isolation
- TilinX App + Mobile connect to Teams instance — same clients, different backend URL

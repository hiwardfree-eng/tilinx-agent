...
Foundation layer for TilinX UI. 37 shadcn/ui components, design tokens, CSS animations, and utilities.

## Install

```bash
pnpm add @tilinx-ai/core
```

## Usage

```tsx
import { Button, Badge, Card, Tooltip } from "@tilinx-ai/core"
import "@tilinx-ai/core/src/globals.css"

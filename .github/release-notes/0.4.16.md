...
Archive missions you have finished, manage your connected apps without leaving TilinX, and keep an eye on how full each conversation is getting, plus a round of chat and routine reliability fixes.
...
- **Manage connected apps in-app.** Reconnect or disconnect a connected app, like Gmail or Slack, right from TilinX, without going elsewhere to fix a broken connection.
...
- **Recover from a stuck chat.** If a chat got stuck mid-activity, TilinX now repairs it on its own instead of staying frozen.

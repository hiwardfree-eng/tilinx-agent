...
Más control sobre cómo tus rutinas usan los chats, notas de actualización en tu propio idioma y una mejora de estabilidad para que TilinX abra sin problemas y cada cosa te lleve al lugar correcto.
...
- **Notas de actualización en tu idioma.** La tarjeta de "actualización disponible" ahora muestra las novedades en español, inglés o portugués, según el idioma con el que usas TilinX.
...
- **TilinX abre aunque un espacio de trabajo tarde en cargar.** La app ya no se queda en una ventana en blanco al iniciar si un espacio de trabajo demora en responder.
...
- **Los reportes de problemas capturan más (en segundo plano).** Algunos errores de la pantalla de TilinX se perdían antes de llegarnos. Ahora se reportan para que podamos corregirlos más rápido. No tienes que hacer nada.

...
- Data consolidates under `~/.tilinx/` (workspaces move out of `~/Documents/TilinX/` automatically on first launch)
...
- Your workspaces will move from `~/Documents/TilinX/` to `~/.tilinx/workspaces/` on first launch. The old location stays as a backup.

...
5. **Write atomically.** Write to `context/operations-context.md.tmp`, then rename to `context/operations-context.md`. Single file at agent root. NOT under subfolder. NOT under `.agents/`. NOT under `.tilinx/<agent>/`.

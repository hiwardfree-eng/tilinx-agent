import { type ChatMessage, EngineError } from "@tilinx/runtime-client";
import { historyToFeed as foldHistoryToFeed } from "@tilinx/sdk";
import type { ChatHistoryEntry } from "../../../../ui/engine-client/src/types";
import { toOldProvider } from "./synthetic";

// The turn error/stop/not-connected classifiers moved into `@tilinx/sdk` with
 ...
 *
 * ONE fold, shared with the SDK (`@tilinx/sdk` `historyToFeed`) — the adapter

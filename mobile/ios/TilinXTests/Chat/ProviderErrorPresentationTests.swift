...
final class ProviderErrorPresentationTests: XCTestCase {
  ...
  func testUnauthenticatedCauseSelectsBody() throws {
    let cases: [(String, String)] = [
      ...
      ("no_credentials", "TilinX needs you to sign in to Claude before it can answer."),
      ("invalid_api_key", "The Claude API key TilinX has is no longer valid. Update it and try again."),
      ("token_revoked", "Your Claude access was revoked. Sign in again to continue."),
      ("mystery", "TilinX could not authenticate with Claude. Reconnect and try again."),
    ]

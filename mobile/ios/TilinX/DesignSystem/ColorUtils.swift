...
/// falls back to TilinX gray (`TILINX_GRAY` in ui/core tilinx-avatar.tsx).
/// This is the one token-adjacent literal the design system owns — every other
/// colour comes from `TilinXColors`.
enum AgentColor {
    /// #9b9b9b — the shared TilinX-gray helmet fallback (ui/core/tilinx-avatar.tsx).
    static let fallback = Color(tilinxHex: "#9b9b9b") ?? Color(.sRGB, red: 0.608, green: 0.608, blue: 0.608)

...
/// `@tilinx/sdk` bridge (`packages/sdk/BRIDGE.md`).
///
...
final class SdkClient: ScopeSubscribing {
  ...
  let log = Logger(subsystem: "ai.gettilinx.sdk", category: "client")
  ...
  /// Attach / rotate the TilinX session bearer (`session/setToken`, BRIDGE.md

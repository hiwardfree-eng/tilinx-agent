/**
 * Pure locale value-logic for the TilinX desktop app — no i18next, no DOM, no
 ...
 * restores the active workspace at startup (see `useTilinXInit`): the
 ...
 * never mounted and the window stayed blank (gettilinx/tilinx#439).
 */

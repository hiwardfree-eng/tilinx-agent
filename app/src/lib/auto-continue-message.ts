/**
 * A "continue the task" message TilinX sends to the agent on the user's
...
const AUTO_CONTINUE_MARKER = "<!--tilinx:auto_continue-->";
...
/** True for a message TilinX auto-sent to resume a task. */

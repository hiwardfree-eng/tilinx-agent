#!/usr/bin/env bash
# Generate a QR PNG that points at gettilinx.ai with UTM params baked in.
#
# Usage:
...
URL="https://gettilinx.ai/?utm_source=qr_code&utm_medium=event&utm_campaign=${CAMPAIGN}&utm_content=${CONTENT}"

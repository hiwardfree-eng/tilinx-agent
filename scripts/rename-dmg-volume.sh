...
#
# Tauri's bundler hardcodes the DMG volume name to `productName` ("TilinX"),
# which makes the mounted disk indistinguishable from the app itself in
# Finder and the macOS dock. We want the disk to read "TilinX Installer"
...
#
# Usage:
#   ./scripts/rename-dmg-volume.sh path/to/TilinX_x.y.z_aarch64.dmg "TilinX Installer"
#
# Notes:
